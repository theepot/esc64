...
static const ReservedWord reservedWords[] =
{
	...
	RES_WORD("movlt", TOKEN_DESCR_OPCODE_MOVNZC),
	RES_WORD("movle", TOKEN_DESCR_OPCODE_MOVZOC),
	RES_WORD("movgt", TOKEN_DESCR_OPCODE_MOVNZNC),
	RES_WORD("movge", TOKEN_DESCR_OPCODE_MOVNC),
