...
//		[TOKEN_DESCR_PAREN_OPEN]			= { "(", TOKEN_CLASS_NONE, TOKEN_VALUE_TYPE_NONE, NULL },
//		[TOKEN_DESCR_PAREN_CLOSE]			= { ")", TOKEN_CLASS_NONE, TOKEN_VALUE_TYPE_NONE, NULL },
//
//		[TOKEN_DESCR_AND]					= { "&", TOKEN_CLASS_OPERATOR, TOKEN_VALUE_TYPE_NONE, &OPERATOR_DESCR_AND },
//		[TOKEN_DESCR_PLUS]					= { "+", TOKEN_CLASS_OPERATOR, TOKEN_VALUE_TYPE_NONE, &OPERATOR_DESCR_PLUS },
//		[TOKEN_DESCR_OR]					= { "|", TOKEN_CLASS_OPERATOR, TOKEN_VALUE_TYPE_NONE, &OPERATOR_DESCR_OR },
//		[TOKEN_DESCR_NOT]					= { "~", TOKEN_CLASS_OPERATOR, TOKEN_VALUE_TYPE_NONE, &OPERATOR_DESCR_NOT },
//		[TOKEN_DESCR_MINUS]					= { "?-", TOKEN_CLASS_AMBIGUOUS_OPERATOR, TOKEN_VALUE_TYPE_NONE, &OPERATOR_DESCR_MINUS },
//		[TOKEN_DESCR_SUB]					= { "sub-", TOKEN_CLASS_OPERATOR, TOKEN_VALUE_TYPE_NONE, &OPERATOR_DESCR_SUB },
//		[TOKEN_DESCR_NEG]					= { "neg-", TOKEN_CLASS_OPERATOR, TOKEN_VALUE_TYPE_NONE, &OPERATOR_DESCR_NEG },
//		[TOKEN_DESCR_DIVIDE]				= { "/", TOKEN_CLASS_OPERATOR, TOKEN_VALUE_TYPE_NONE, &OPERATOR_DESCR_DIVIDE },
//
...
void PrintToken(FILE* stream, const Token* token)
{
	switch(token->id)
	{
	case TOKEN_ID_AND:			fprintf(stream, "TOKEN_ID_AND(%d)", TOKEN_ID_AND); break;
	case TOKEN_ID_PLUS:			fprintf(stream, "TOKEN_ID_PLUS(%d)", TOKEN_ID_PLUS); break;
	case TOKEN_ID_OR:			fprintf(stream, "TOKEN_ID_OR(%d)", TOKEN_ID_OR); break;
	case TOKEN_ID_NOT:			fprintf(stream, "TOKEN_ID_NOT(%d)", TOKEN_ID_NOT); break;
	case TOKEN_ID_SUB:			fprintf(stream, "TOKEN_ID_SUB(%d)", TOKEN_ID_SUB); break;
	case TOKEN_ID_DIV:			fprintf(stream, "TOKEN_ID_DIV(%d)", TOKEN_ID_DIV); break;
	case TOKEN_ID_COMMA:		fprintf(stream, "TOKEN_ID_COMMA(%d)", TOKEN_ID_COMMA); break;
	case TOKEN_ID_PAREN_OPEN:	fprintf(stream, "TOKEN_ID_PAREN_OPEN(%d)", TOKEN_ID_PAREN_OPEN); break;
	case TOKEN_ID_PAREN_CLOSE:	fprintf(stream, "TOKEN_ID_PAREN_CLOSE(%d)", TOKEN_ID_PAREN_CLOSE); break;
	case TOKEN_ID_NUMBER:		fprintf(stream, "TOKEN_ID_NUMBER(%d, %d)", TOKEN_ID_NUMBER, token->intValue); break;
	case TOKEN_ID_LABEL_REF:	fprintf(stream, "TOKEN_ID_LABEL_REF(%d)", TOKEN_ID_LABEL_REF); break;
	case TOKEN_ID_REG:			fprintf(stream, "TOKEN_ID_REG(%d, %d)", TOKEN_ID_REG, token->intValue); break;
	case TOKEN_ID_STRING:		fprintf(stream, "TOKEN_ID_STRING(%d)", TOKEN_ID_STRING); break;
	case TOKEN_ID_LABEL_DECL:	fprintf(stream, "TOKEN_ID_LABEL_DECL(%d)", TOKEN_ID_LABEL_DECL); break;
	case TOKEN_ID_INST:			fprintf(stream, "TOKEN_ID_INST(%d)", TOKEN_ID_INST); break;
	case TOKEN_ID_DIR:			fprintf(stream, "TOKEN_ID_DIR(%d)", TOKEN_ID_DIR); break;
	case TOKEN_ID_EOL:			fprintf(stream, "TOKEN_ID_EOL(%d)", TOKEN_ID_EOL); break;
	case TOKEN_ID_EOF:			fprintf(stream, "TOKEN_ID_EOF(%d)", TOKEN_ID_EOF); break;
	case TOKEN_ID_COUNT_:		fprintf(stream, "[ILLEGAL]TOKEN_ID_COUNT_(%d)", TOKEN_ID_COUNT_); break;
	case TOKEN_ID_INVALID:		fprintf(stream, "[ILLEGAL]TOKEN_ID_INVALID(%d)", TOKEN_ID_INVALID); break;
	default:					fprintf(stream, "UNKNOWN_TOKEN_ID(%d)", token->id); break;
	}
}
#endif
