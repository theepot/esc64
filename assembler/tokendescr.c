...
const TokenDescr TOKEN_DESCR_LABEL_REF		= { "lref", TOKEN_CLASS_LABEL_REF, TOKEN_VALUE_TYPE_STRING };
const TokenDescr TOKEN_DESCR_REGISTER_REF	= { "reg", TOKEN_CLASS_REGISTER_REF, TOKEN_VALUE_TYPE_NUMBER };
