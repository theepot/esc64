...
void print_SRAM(FILE* f, const SRAM_t* mem, int number_of_words);
...
//void send_block_with_header(const SRAM_t* mem, int block);
...
int command_upload(const SRAM_t* mem, int block);
int command_download(SRAM_t* mem, int block, bool* out_download_success);
